...
public class MainApp {
	...
	public static void main(String[] args) {
		...
		//here we create two objects but the hash code of both objects are same because spring implicitly follows singleton
		//pattern we have to change it explicitly by providing scope="prototype" in config.xml file.
