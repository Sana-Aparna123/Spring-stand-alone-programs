...
public class MainApp {
	...
	public static void main(String[] args) {
		...
		//here we create two objects the hash code of both objects are different because we instruct the spring explicitly 
		//by providing scope="prototype" in config.xml file.
